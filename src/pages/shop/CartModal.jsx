...
const CartModal = ({ products, isOpen, onClose }) => {
    ...
    // increment & decrement
    const haldleUpdateQuantity = (type, id) => {
  ...
  return (
    <div>
      <div
        className={`fixed z-1000 inset-0  bg-opacity-50 transition-opacity`}
                ...
                products.map((product, index) => (
                  <div key={product._id} className="flex flex-col md:flex-row md:items-center md:justify-between shadow-md md:p-5 p-2 mb-4">
                    ...
                    <div className="flex flex-row md:justify-start justify-end items-center mt-2">
                      <button onClick={()=>haldleUpdateQuantity("decrement", product?._id)} className="size-6 flex items-center justify-center px-1.5 rounded-full bg-gray-200 text-gray-700 hover:bg-primary hover:text-white ml-8">
                        -
                      </button>
                      ...
                      <button onClick={()=>haldleUpdateQuantity("increment", product?._id)} className="size-6 flex items-center justify-center px-1.5 rounded-full bg-gray-200 text-gray-700  hover:bg-primary hover:text-white">
                        +
                      </button>
                      <div className="ml-5">
