...
const UserDMain = () => {
  ...
  const { totalPayments, totolPurchasedProducts, totalReviews } = stats;

  console.log(totalPayments, totolPurchasedProducts, totalReviews);
  ...
  const data = {
    ...
    datasets: [
      {
        label: "User Stats",
        data: [totalPayments, totalReviews, totolPurchasedProducts],
        backgroundColor: [
          "rgba(255, 99, 132, 0.2)",
          "rgba(255, 159, 64, 0.2)",
          "rgba(255, 205, 86, 0.2)",
